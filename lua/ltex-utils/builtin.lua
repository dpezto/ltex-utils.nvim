...
---Creates new picker window for modifying rules or words.
...
---Opens picker to modify hidden false positive rules.
...
---Opens picker to modify disabled rules list.
builtin.modify_disabledRules = function ()
	new_win("disabledRules", Config.diagnostics.diags_disable_rules)
end

---Opens picker to modify dictionaries (including saved ones).
